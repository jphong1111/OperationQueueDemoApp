...
class PhotoViewModel {
    ...
    init(operations: PendingOperations = PendingOperations(), delegate: PhotoListViewModelDelegate) {
...
class PendingOperations {
    ...
    func downloadOperation(at indexPath: IndexPath) -> Operation? {
        return downloadInProgress[indexPath]
    }
    
    func filterOperation(at indexPath: IndexPath) -> Operation? {
        return filterInProgress[indexPath]
    }
